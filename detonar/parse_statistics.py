...
# Might actually only need these 10 ?
...
data = feature_extractor.get_data(args.path_to_file)
nodes_names = feature_extractor.get_unique_nodes_names(data)

for node in nodes_names:
    with open('extended_features/{}/{}/{}/{}.csv'.format(args.scenario, args.simulation_time, args.simulation, node), 'w') as output_file:
